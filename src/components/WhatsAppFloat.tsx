...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white transition-transform hover:scale-110 hover:bg-[#20ba59]"
      style={{ boxShadow: "0 4px 24px rgba(37,211,102,0.45)" }}
    >
      {/* WhatsApp SVG — more authentic than the generic MessageCircle */}
